...
In this lab, you will run the OLAP application and queries on HeatWave and in MySQL. You will see the application and query performance improvements on HeatWave.
...
## Task 1: Run OLAP (Reports) Application

1. Run the application... be sure to use the actual ComputeIP :

    http://132.145...

    ![oltp_airport](./images/oltp_airport.png "oltp_airport")

2. Test the application OLTP function
    - a. Run http://132.145...
    - b. Clik **Book a Flight Ticket** - Select a Country **result is fast**

3. Test the application OLAP function
    - a. Run http://132.145...
    = b. Click **Create Load Factor Reports**
    - c. Select **Monthly load factor of each flight route** and click the "Generate Report" button **result is fast**
